...
STOP_WORD_FILE = 'Attach/stopwords-en.txt'
...
if choice == "Trang chủ":
    ...
    st.image('Attach/WC_TopProduct_VIP.png')
    st.write('#### WordCloud top sản phẩm của PK KH Trung thành:')
    st.image('Attach/WC_TopProduct_LOYAL.png')
    st.write('#### WordCloud top sản phẩm của PK KH Mới:')
    st.image('Attach/WC_TopProduct_NEW.png')
    st.write('#### WordCloud top sản phẩm của PK KH Vãng lai:')
    st.image('Attach/WC_TopProduct_TRAVELLER.png')
    st.write('#### WordCloud top sản phẩm của PK KH Rời bỏ:')
    st.image('Attach/WC_TopProduct_LOST.png')
    st.write('#### WordCloud top sản phẩm của PK KH Thông thường:')
    st.image('Attach/WC_TopProduct_REGULARS.png')


elif choice == "Cơ chế phân nhóm":
    st.image('Attach/customer-segmentation-social.png')
    ...
    st.write('### TreeMap')
    st.image('Attach/RFM_Plot.png')
    st.write('### Scatter Plot (RFM)')
    st.image('Attach/Scatter Plot.png')

elif choice=='Phân tích khách hàng':
    st.image('Attach/segmentation.webp')
